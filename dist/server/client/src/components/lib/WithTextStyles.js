...
const withTextStyles = (props) => {
    const { textContent, types, style, serve: Component = 'div', sofia, impact, andali, monaco, verdana, comic, platino, serif, gadget, monospace, sansserif, arial, timesnewroman, tahoma, georgia, fantasy, garamond, cursive, cursive_mt, scripture, innocent, focus, shadowblack, mui, seinna, gas, rose, sheen, potion, ruby, pumpkin, dungeon, beaver, razzmatazz, shadow1black, shadow2black, shadow3black, shadowred, shadowsofia, shadow2red, shadow3red, shadowgrey, shadowgreylight, shadow1grey, shadow2grey, shadow3grey, ...rest } = props;
    ...
    switch (types) {
        case 'typography': {
            return (0, jsx_runtime_1.jsx)(Typography_1.default, { ...rest, style: { ...style,
                    ...(fontFamily && { fontFamily }),
                    ...(textShadow && { textShadow }),
                }, children: textContent });
        }
        default: {
            return (0, jsx_runtime_1.jsx)(Component, { ...rest, style: { ...style,
                    ...(fontFamily && { fontFamily }),
                    ...(textShadow && { textShadow }),
                }, children: textContent });
        }
