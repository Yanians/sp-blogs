...
const createCustomShadow = color => {
  ...
  return {
    ...
    primary: `0 8px 16px 0 ${(0, _styles.alpha)(_palette.default.primary.main, 0.24)}`,
    secondary: `0 8px 16px 0 ${(0, _styles.alpha)(_palette.default.secondary.main, 0.24)}`,
    info: `0 8px 16px 0 ${(0, _styles.alpha)(_palette.default.info.main, 0.24)}`,
    success: `0 8px 16px 0 ${(0, _styles.alpha)(_palette.default.success.main, 0.24)}`,
    warning: `0 8px 16px 0 ${(0, _styles.alpha)(_palette.default.warning.main, 0.24)}`,
    error: `0 8px 16px 0 ${(0, _styles.alpha)(_palette.default.error.main, 0.24)}`
  };
};
const customShadows = exports.customShadows = createCustomShadow(LIGHT_MODE);
