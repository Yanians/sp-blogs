...
const Root = styled('div')(
  ({ theme }) => ({
    ...
    '& pre': {
      ...
      backgroundColor: 'hsl(315, 95.60%, 8.80%)', // a special, one-off, color tailored for the code blocks using MUI's branding theme blue palette as the starting point. It has a less saturaded color but still maintaining a bit of the blue tint.
      color: 'hsl(188, 51.70%, 94.30%)',
      colorScheme:theme.palette.mode === 'dark' ? lightTheme.palette.primaryDark[700]: 'light',
    ...
    '& .description': {
      ...
      fontWeight: 400,
      backgroundColor:theme.palette.mode === 'dark'?lightTheme.palette.success[300] : darkTheme.palette.primaryDark,
      margin: '0 0 24px',
    },
    '& .component-tabs': {
      margin: '0 0 40px',
    ...
    '& h1, & h2, & h3, & h4': {
      ...
      '& .title-link-to-anchor': {
        color: theme.palette.mode === 'dark' ? theme.palette.text.secondaryChannel : 'inherit',
        textDecoration: 'none',
        boxShadow: 'none',
        fontWeight: 'inherit',
        position: 'relative',
