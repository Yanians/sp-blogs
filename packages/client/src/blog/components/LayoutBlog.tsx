...
interface pageProps {
 ...
 function LayoutBlog(props:pageProps) {
    ...
    return (
            <div className={classes.root}>
              { directives.map((content: any, index: React.Key | null | undefined)=>{
                    return(
                    <Paper variant='outlined' sx={{m:1 }} key={index}>
                              ...
                              <GridLeftItem>
                                ...
                                <GridRightItem>
                                  <Stack direction={'column'} sx={{ml:2}}>
                                       <TextLink serve={Link} to="/" shadowsofia comic color="success" textContent={
                                           <TextLink types='typography' color='success' component={'div'} noWrap sx={{flexGrow:1}}
                                                textContent={content.tags} />
                                        } />
                                    <Typography variant='caption' component={'div'} noWrap>
                                      {content.authors.find((author:any)=>author)}
                                    </Typography>  
                                  </Stack>     
                                </GridRightItem>
                        </MainGridContainer>
...
const defaultTheme = createTheme()
  export default withStyles(styles,{defaultTheme})(LayoutBlog);
