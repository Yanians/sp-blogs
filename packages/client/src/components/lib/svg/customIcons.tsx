...
export function GithubIcon(){
  return(
         <svg  aria-hidden="true" 
                ...
                className="svg-inline--fa fa-github-square fa-w-14 fa-lg share-icon" 
                role="img" 
...
export function LinkedinIcon(){
  return(
       <svg 
          ...
          data-prefix="fab" 
          data-icon="linkedin" 
          className="svg-inline--fa fa-linkedin fa-w-14 fa-lg share-icon s17ojqon" 
          role="img" 
          xmlns="http://www.w3.org/2000/svg" 
          viewBox="0 0 448 512">
...
export function TwitterIcon(){
   return(
      <svg aria-hidden="true" 
          ...
          className="svg-inline--fa fa-twitter-square fa-w-14 fa-lg share-icon" 
          role="img" 
          xmlns="http://www.w3.org/2000/svg" 
          viewBox="0 0 448 512">
...
// export function SocialIcon<C extends React.ElementType>(props:LinkProp<C>){
//    const { socialLink, component:Component = Link, ...other} = props;
//   return (
//     <SvgIcon sx={{ height: 21, width: 100 }}>
//      <>
//      <Component to={socialLink}>
...
type LinkProp<C extends React.ElementType> = {
 component:C;
 socialLink?:string;
