...
const Background=(props:Shadows) => {
  ...
  function BackgroundEffects<C extends React.ElementType>(props:OutputProps<C>): React.JSX.Element {
...
type AllProps<C extends React.ElementType>={
  preserve?:C;
  [key:string]: any; 
} & Omit<React.ComponentPropsWithoutRef<C>, 'preserve'|'children'> & Shadows & AdditionalProps;
