...
const POST_INFO = [
    { number: 1, icon: ForwardToInbox_1.default },
    { number: 2, icon: Visibility_1.default },
    { number: 3, icon: Share_1.default }
];
function BlogPostCard(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(material_1.Grid, { size: { xs: 6, sm: 4, md: 3 }, children: (0, jsx_runtime_1.jsxs)(material_1.Card, { sx: { position: 'relative' }, children: [(0, jsx_runtime_1.jsxs)(CardMediaStyle, { sx: {
                        pt: 'calc(100% * 4 / 3)',
                        '&:after': {
                            top: 0,
                            content: "''",
